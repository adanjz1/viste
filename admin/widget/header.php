                        ...
                        <div class="container-fluid">
                            ...
                            <div class="nav-collapse collapse">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><a href="tablePack.php?cat=1">Packaging</a></li>
                                    <li><a href="tablePack.php?cat=2">Laser</a></li>
                                    <li><a href="tablePack.php?cat=3">Pop</a></li>
                                </ul>
                                <!-- /.nav -->
                            </div>
                        </div>
