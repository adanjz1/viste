...
$productos = R::find('producto',' categoria = ? ', array(3));
?>
        <script>
                ...
                <div id = "carousel1" style="width:256px; height:128px;background:#000;overflow:scroll;">            
                 <?
                        foreach($productos as $producto){
                            ...
                            echo '<img class = "cloudcarousel" src="media/uploads/'.$fotoPrinc.'" title="'.utf8_decode($producto->nombre).'" onclick="document.location=\'details.php?id='.$producto->id.'&sec=pop\'" />';
                        }
                    ?>
                </div>
        ...
        <div class="box box-element" style="display: block;">
            ...
            <div class="bottmLaser" style="width:100%;">
                <h3 class="negroyazul" style="text-align:center">Como trabajamos?</h3>
                <div class=" imgLaserEnd" style="margin:auto;width: 63%;margin-bottom: 20px;">
                    <img class="popGrafica" src="media/img/graficas_pop.jpg">
                </div>
            </div>
